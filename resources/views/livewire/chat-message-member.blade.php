            ...
            <div class="sidebar">
                ...
                <div class="sidebar-content {{ $activeSidebarMobile == true ? 'show' : '' }}">
                    ...
                    <div class="chat-fixed-search">
                        <div class="d-flex align-items-center w-100">
                            <div class="sidebar-profile-toggle">
                                <div class="avatar avatar-border">
                                    @if (auth('member')->user()->profileImg)
                                        <img src="{{ asset('/' . auth('member')->user()->profileImg) }}"
                            ...
                            <div class="input-group input-group-merge ms-1 w-100">
                                <span class="input-group-text round"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div id="users-list" class="chat-user-list-wrapper list-group ps ps__rtl ps--active-y">
                        <h4 class="chat-list-title">الأعضاء</h4>
                        <ul class="chat-users-list chat-list media-list" wire:ignore>
                            @forelse ($members as $member)
                                <li wire:click="userTarget({{ $member->id }})">
                                    <span class="avatar">
                                        @if ($member->image != null)
                                            <img src="{{ asset($member->image) }}" height="42" width="42"
                                                alt="Generic placeholder image">
                                        @else
                                            <img src="{{ asset('assets/images/user.png') }}" height="42"
                            ...
                            @empty
                                <li class="no-results">
                                    <h6 class="mb-0">لا يوجد أعضاء حتي الآن</h6>
                                </li>
                            @endforelse
                        </ul>
                        ...
                        <div class="ps__rail-y" style="top: 0px; height: 119px; left: 353px;">
                    ...
                    <section class="chat-app-window">
                        ...
                        @if ($active_chat == false)
                            <div class="start-chat-area text-center">
                                ...
                                <h4 class="sidebar-toggle start-chat-text">اختر عضو لبدء المحادثة ...</h4>
                            </div>
                        @endif
                        <!--/ To load Conversation -->
                                    ...
                                    <header class="chat-header">
                                        <div class="d-flex align-items-center">
                                            <div class="sidebar-toggle d-block d-lg-none me-1"
                                                wire:click="sidebarContentMobileActive">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            ...
                                            <div class="avatar avatar-border user-profile-toggle m-0 me-1">
                                                @if ($userInfo->image == null)
                                                    <img src="{{ asset('assets/images/user.png') }}" height="42"
                                                        width="42" alt="Generic placeholder image">
                                                @else
                                                    <img style="width: 80px" src="{{ asset('/' . $userInfo->image) }}"
                                                        alt="img">
                                                @endif
                                            </div>
                                            <h6>{{ $userInfo->name }}</h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="dropdown" wire:ignore>
                                                <button
                                                    class="btn-icon btn btn-transparent hide-arrow btn-sm dropdown-toggle waves-effect waves-float waves-light"
                                        ...
                                        @foreach ($AllMessages as $message)
                                                ...
                                                <div class="chat">
                                                    ...
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                            <h5 class="text-white">{{ auth('member')->user()->name }}
                                                            </h5>
                                                            <p>{{ $message->message }}</p>
                                                        </div>
                                                    </div>
                                            ...
                                            @else
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <span class="avatar box-shadow-1 cursor-pointer">
                                                            <img src="{{ asset($message->conversion->sender->profileImg) }}"
                                                                alt="avatar" height="36" width="36">
                                                        </span>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                            <h5 class="text-muted">
                                                                {{ $message->conversion->sender->name }}</h5>
                                                            <p>{{ $message->message }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach
                                        @if ($conversion->is_active == 0)
                                            <div class="alert alert-danger">
                                                <div class="alert-body">
                                                    <p>لا يمكنك التحدث إلي هذا العضو في الوقت الحالي !</p>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                                    ...
                                    <form class="chat-app-form" wire:submit.prevent="sendMessage"
                                            ...
                                            <span class="input-group-text">
                                                <label for="attach-doc" class="attachment-icon form-label mb-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                        ...
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round"
                                                        class="feather feather-image cursor-pointer text-secondary">
                                                        <rect x="3" y="3" width="18" height="18"
                                                            rx="2" ry="2"></rect>
                                                        <circle cx="8.5" cy="8.5" r="1.5"></circle>
                                                        <polyline points="21 15 16 10 5 21"></polyline>
                                                    </svg>
                                                    <input type="file" wire:model="attachFile" id="attach-doc"
                                                        hidden="">
                                                </label>
                                            </span>
                                        </div>
                                        <button type="submit"
                                            ...
                                            {{ $conversion->is_active == 1 ? '' : 'disabled' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
